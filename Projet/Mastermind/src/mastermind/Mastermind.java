...
public class Mastermind
{
    ...
    /**
     * L'ordinateur doit trouver une combinaison généré aléatoirement
     */
    public static final int ORDI_VS_ORDI = 0;
    /**
     * L'ordinateur doit trouver une combinaison entrée par l'utilisateur
     */
    public static final int USER_VS_ORDI = 1;
    /**
     * Le joueur doit trouver une combinaison génrée aléatoirement
     */
    public static final int ORDI_VS_USER = 2;
    /**
     * Un joueur doit trouver un combinaison entrée par un autre joueur
     */
    ...
    /**
     * Demmande au joueur d'entrer des combinaisons afin de trouver celle à
     * deviner
     *
     * @return true si la combinaison a été trouvé dans le nombre d'essai
     * impartis
     */
    ...
    /**
     * Retourne vraie si le nombre maxium d'essai est dépassé et que le nombre
     * d'essais est limité
     *

...
/**
 * Cette classe permet de trouver une combinaison étape par étape. Il va dans un
 * premier temps trouver le nombre de pions de chaque couleur qui sont dans la
 * combinaison à trouver Ensuite il va essayer toutes les possibilités avec ces
 * pions trouvés
 *
 * @author Jordan
 */
public class Resolver
{
    ...
    /**
     * @return la combinaison que l'algo a trouvé
     */
